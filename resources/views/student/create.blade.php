...
<main>
    ...
    <div class="card" style="max-width: 700px; margin: 0 auto;">
        <div class="card-header">
            ...
            <p class="card-subtitle">Enter the student's details</p>
        </div>

        <form action="{{ route('students.store') }}" method="POST" class="card-body">
            @csrf
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    id="contact_number"
                    name="contact_number" 
                    class="@error('contact_number') error @enderror"
